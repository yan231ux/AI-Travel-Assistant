...
public class ItineraryGenerator {
    ...
    private String buildGenerationPrompt(TripRequest request, String dataSummary) {
        ...
        return String.format("""
                ...
                3. 餐厅必须选择当地特色餐厅（火锅、本帮菜、小吃等），禁止推荐连锁快餐或连锁品牌（如肯德基、麦当劳、汉堡王、星巴克、必胜客、海底捞、巴奴、呷哺呷哺、西贝、外婆家、费大厨等全国连锁），连锁不同分店也算连锁
                ...
                6. 天数必须精确：必须输出恰好 %d 天（day_index 从 1 连续到 %d，date 与「出行日期」逐日对应，既不得少排也不得多排）；每天安排 2-4 个主要景点，禁止只排 1 个景点就结束当天；每天 theme 必须概括当天实际安排的景点内容，禁止把其他天才去的景点写进当天主题
